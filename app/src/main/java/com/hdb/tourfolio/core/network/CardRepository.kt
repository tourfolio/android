...
class CardRepository
     ...
     * 카드 상세 조회
     */
        suspend fun getCardDetail(cardId: Long): CardDetailDto =
     ...
     * 카드 관광지 좌표 조회
     */
        suspend fun getCardLocation(cardId: Long): CardLocationDto =
     ...
     * 카드 획득
     */
        suspend fun acquireCard(cardId: Long): CardAcquireDto =
