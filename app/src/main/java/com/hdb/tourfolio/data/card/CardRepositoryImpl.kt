...
private val localCards =
    listOf(
        LocalCard(1, "경복궁", "서울특별시 종로구 사직로 161", CardRarity.RARE, "역사", "서울", 37.5760307000493, 126.976721866063, "조선의 시간을 품은 궁궐"),
        LocalCard(2, "동궁과 월지", "경상북도 경주시 원화로 102", CardRarity.RARE, "역사", "경북", 35.8352023996, 129.2283747104, "달빛 아래 되살아나는 신라"),
        LocalCard(3, "감천문화마을", "부산광역시 사하구 감내2로 203", CardRarity.RARE, "문화", "부산", 35.0974606978369, 129.010596996534, "산복도로에 피어난 색채"),
        LocalCard(
            4,
            "성산일출봉",
        ...
        LocalCard(5, "광안리해수욕장", "부산광역시 수영구 광안해변로 219", CardRarity.RARE, "자연", "부산", 35.1537727886, 129.1185199367, "도시의 밤을 비추는 바다"),
        LocalCard(6, "남산서울타워", "서울특별시 용산구 남산공원길 105", CardRarity.RARE, "문화", "서울", 37.5510545366352, 126.987882083295, "서울의 빛을 한눈에 담는 곳"),
    )

private fun List<LocalCard>.findCard(cardId: Long): LocalCard = firstOrNull { it.id == cardId } ?: error("존재하지 않는 카드입니다: $cardId")

private fun acquiredDateKey(
    userId: Long,
    cardId: Long,
